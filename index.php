...
<html lang="en">
    ...
    <body>
      ...
      <div class="header_section">
        <nav class="destop_header navbar navbar-expand-lg  navbar-expand-md  navbar-light bg-light">
          <!-- <div class="logo"></div> -->
                  ...
                  <div class="carousel-item active">
                    <div class="banner_bg">
                      <div class="banner_taital_main">
                        <p class="banner_taital">Surabe Clinic</p>
                        ...
                        <div class="btn_main">
                          <div class="about_us"><a href="#">Register Now</a></div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="about_taital">
                ...
                <div class="read_bt"><a href="#">Feedbacks</a></div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="image_2" href="#"><img src="images/img-2.jpg"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="contact_section layout_padding" style="margin-bottom: 30px; margin-top: 100px;">
      <div class="container">
        <div class="wrapper">
            <h1>Our Services</h1>
            ...
            <div class="content-box">
                <div class="card-box">
                    ...
                    <p>
                        ...
                        laborum hic uod reiciendis similique. Explicabo fugit ullam quo
                        saepe!
                    </p>
                </div>
      ...
      <!-- info section -->
    <div class="info_section layout_padding" style="margin-top: 10px;">
      <div class="container ">
